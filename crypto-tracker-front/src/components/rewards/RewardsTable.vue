<template>
  <v-container class="pa-1">
    <v-row class="text-center">
      <v-col cols="12">
        <v-data-table dark dense :loading="loadingRewards" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :headers="headers" :items="rewards" item-key="id" class="elevation-10" hide-default-footer disable-pagination>
          <template v-slot:top>
            <v-toolbar flat>
